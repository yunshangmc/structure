...
//		this.harvesting = this.points.filter(x => x.harvesting)
	...
	getStats() {
		...
		return {
			...
			tookLocal : this.complete?this.completeTime&&this.relativeStart?timeString(this.completeTime - this.relativeStart):"未知":this.relativeStart?timeString((game.map != this?(this.lastLeft || this.relativeStart):(currentTime)) - this.relativeStart):"未知",
